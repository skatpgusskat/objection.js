...
module.exports = session => {
  ...
  describe.only('GraphInsert tests', () => {
    let Pet = null;
    let Person = null;
    let mockKnex = null;
    ...
    function test({
      ...
      if (Object.keys(rest).length > 0) {
        throw new Error(`unsupported properties ${Object.keys(rest)}`);
      }
    ...
    function createModels() {
      ...
      Person = class PersonModel extends Model {
        ...
        $parseDatabaseJson(json) {
          for (const [prop, propSchema] of Object.entries(this.constructor.jsonSchema.properties)) {
